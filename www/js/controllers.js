...
.controller('detailProductCtrl', ['$scope', '$stateParams', 'productService', '$cordovaDialogs', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
// You can include any angular dependencies as parameters for this function
// TIP: Access Route Parameters for your page via $stateParams.parameterName
function ($scope, $stateParams, productService, $cordovaDialogs) {
  ...
  /*$scope.deleteProduct = function(){
      $cordovaDialogs.confirm('Eliminar el producto', 'Confirma eliminar el producto', ['Aceptar','Cancelar'])
      .then(function(buttonIndex) {

          console.log(_data);

          var btnIndex = buttonIndex;
          console.log(btnI ndex);
          if(btnIndex == 1){ //Aceptar
            productService.item_delete.delete({id: $stateParams.id}, function(_data){
            console.log(_data);
            $scope.data_product = _data;
              });
